...
CREATE TABLE DOCTOR_CLINIC_ASSIGNMENT (
  ...
  FOREIGN KEY (clinic_id) REFERENCES UBER_CLINICS (id) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1;

-- NURSE CLINIC ASSIGNMENTS
DROP TABLE IF EXISTS NURSE_CLINIC_ASSIGNMENT;
CREATE TABLE NURSE_CLINIC_ASSIGNMENT (
  id int(11) NOT NULL AUTO_INCREMENT,
  clinic_id int(11) DEFAULT NULL,
  nurse_id int(11) DEFAULT NULL,
  PRIMARY KEY (id),
  FOREIGN KEY (nurse_id) REFERENCES DOCTORS (id) ON DELETE NO ACTION ON UPDATE NO ACTION,
  FOREIGN KEY (clinic_id) REFERENCES UBER_CLINICS (id) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1;
