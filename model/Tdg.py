...
class Tdg:
    ...
    def update_room_slot(self, room_slot):
        ...
        if room_slot.id is None:
            cur.execute("INSERT INTO ROOM_SLOTS (id, room_id, slot_id, walk_in, doctor_id, patient_id) VALUES(NULL, %s, %s, %s, %s, %s)", (room_slot.room_id, room_slot.slot_yearly_index, room_slot.walk_in, room_slot.doctor_id, room_slot.patient_id))
        else:
