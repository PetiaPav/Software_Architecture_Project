...
class Mediator:
    ...
    def add_appointment(self, patient_id, clinic_id, start_time, walk_in):
        return self.__appointment_registry.add_appointment(patient_id, clinic_id, start_time, walk_in)
