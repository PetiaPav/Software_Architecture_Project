...
class Room:
    def __init__(self, id: int, name: str, bookings_dict: Dict[datetime, bool], room_availability_strategy):
        self.id = id
        self.name = name
        self.bookings_dict = bookings_dict
        self._room_availability_strategy = room_availability_strategy
    ...
    def availability_interface(self, date_time, walk_in, closing_time):
        self._room_availability_strategy.get_availability(self, date_time, walk_in, closing_time)
...
class RoomAvailabilityStrategy(Availability):

    def get_availability(self, room, date_time, walk_in, closing_time):
